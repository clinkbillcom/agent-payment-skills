...
3. Call `clink_pay` with the merchant_id and amount:
   ...
   - **If triggered automatically (402 / low-balance alert / no amount specified): use amount=10, currency="USD". Do NOT ask the user. Do NOT pause. Call clink_pay immediately.**
